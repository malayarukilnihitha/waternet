...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--epochs", type=int, default=50, help="(Optional) Num epochs, defaults to 400"
    )
    parser.add_argument(
        "--batch-size",
        type=int,
    ...
    dataset = UIEBDataset(
        projectroot / "/home/n/nihita/pp_codes/data/raw-890",
        projectroot / "/home/n/nihita/pp_codes/data/reference-890",
        im_height=im_height,
        im_width=im_width,
    )
