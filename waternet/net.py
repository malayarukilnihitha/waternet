...
class ConfidenceMapGenerator(nn.Module):
    def __init__(self):
        ...
        self.conv3 = nn.Conv2d(
            in_channels=128, out_channels=64, kernel_size=3, dilation=1, padding="same"
        )
        self.relu3 = nn.ELU()
        self.conv4 = nn.Conv2d(
            in_channels=64, out_channels=64, kernel_size=1, dilation=1, padding="same"
        )
        self.relu4 = nn.ELU()
        ...
        self.conv6 = nn.Conv2d(
            in_channels=64, out_channels=32, kernel_size=5, dilation=1, padding="same"
        )
        self.relu6 = nn.ReLU()
        self.conv7 = nn.Conv2d(
            in_channels=32, out_channels=32, kernel_size=3, dilation=1, padding="same"
        )
        self.relu7 = nn.ELU()
        self.conv8 = nn.Conv2d(
            in_channels=32, out_channels=3, kernel_size=1, dilation=1, padding="same"
        )
...
class Refiner(nn.Module):
    def __init__(self):
        super().__init__()
        self.conv1 = nn.Conv2d(
            in_channels=6, out_channels=64, kernel_size=7, dilation=1, padding="same"
        )
        self.conv2 = nn.Conv2d(
            in_channels=64, out_channels=32, kernel_size=5, dilation=1, padding="same"
        )
        self.conv3 = nn.Conv2d(
            in_channels=32, out_channels=16, kernel_size=3, dilation=1, padding="same"
        )
        self.conv4 = nn.Conv2d(
            in_channels=16, out_channels=3, kernel_size=3, dilation=1, padding="same"
        )
        self.relu1 = nn.ReLU()
        self.relu2 = nn.ReLU()
        self.relu3 = nn.ReLU()
